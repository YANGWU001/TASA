...
def run_baseline(method, dataset):
    """运行单个baseline评估"""
    print(f"\n{'='*80}")
    print(f"🚀 Running {method} on {dataset} (Qwen)")
    print(f"{'='*80}\n")
    ...
    # 设置环境变量 - 使用Qwen配置
    env = os.environ.copy()
    env['TASA_CONFIG'] = 'tasa_config_qwen'
...
def main():
    print("╔══════════════════════════════════════════════════════════════════════════════╗")
    print("║          🚀 Qwen Baseline评估 - 所有方法和数据集                           ║")
    print("╚══════════════════════════════════════════════════════════════════════════════╝")
    print(f"\n📊 配置:")
    ...
    print(f"  • Backbone: Qwen3-4B-Instruct")
    ...
    # 保存结果
    results_file = '/mnt/localssd/logs/baseline_qwen_all_results.json'
    import json
