...
TASA_PID=74812
LOG_FILE="/mnt/localssd/logs/auto_baseline_starter_v2.log"
...
cd /mnt/localssd
nohup /opt/venv/bin/python3 -u run_baselines_parallel_with_env.py > logs/baselines_llama_qwen_final.log 2>&1 &
BASELINE_PID=$!

echo "✅ Baseline已启动！" | tee -a $LOG_FILE
echo "📋 PID: $BASELINE_PID" | tee -a $LOG_FILE
echo "📝 日志: logs/baselines_llama_qwen_final.log" | tee -a $LOG_FILE
echo "" | tee -a $LOG_FILE
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━" | tee -a $LOG_FILE
