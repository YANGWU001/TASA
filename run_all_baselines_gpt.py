...
def run_baseline(method, dataset):
    """运行单个baseline评估"""
    print(f"\n{'='*80}")
    print(f"🚀 Running {method} on {dataset} (GPT-oss-120b)")
    print(f"{'='*80}\n")
...
def main():
    ...
    # 保存结果
    results_file = '/mnt/localssd/logs/baseline_gpt_all_results.json'
    import json
